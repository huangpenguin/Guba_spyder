...
if __name__ == '__main__':
    headers = {
        'Mozilla / 5.0(Windows NT 10.0;Win64;x64) AppleWebKit / 537.36(KHTML, likeGecko) Chrome / 119.0.0.0Safari / 537.36'
    ...
    bro = webdriver.Chrome(executable_path=r'E:\guba_spider-main\chromedriver-win64\chromedriver-win64\chromedriver.exe'
                           , options=chrome_options
                           )
    codes = pd.read_excel('Code.xlsx', dtype='object')
    for code in codes['Code']:
        ...
        response = bro.page_source
        tree = etree.HTML(response)
        page_num = tree.xpath('// *[ @ id = "mainlist"] / div / ul / li[1] / ul / li[7] / a / span')
